class DependenciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dependency.save
        format.html { redirect_to @dependency, notice: 'La dependencia fue creada exitosamente' }
  ...
  def update
    ...
    respond_to do |format|
      if @dependency.update_attributes(params[:dependency])
        format.html { redirect_to @dependency, notice: 'La dependencia fue modificada exitosamente' }
