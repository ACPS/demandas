...
class DemandsControllerTest < ActionController::TestCase
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post :create, demand: { address: @demand.address, case: @demand.case, last_name: @demand.last_name, name: @demand.name }
    end
  ...
  test "should update demand" do
    put :update, id: @demand, demand: { address: @demand.address, case: @demand.case, last_name: @demand.last_name, name: @demand.name }
    assert_redirected_to demand_path(assigns(:demand))
  end
